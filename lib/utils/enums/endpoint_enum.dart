...
extension GetEndPointPath on EndPoint {
  ...
  // Sửa lỗi ở đây: thay thế @required bằng required
  String getPath({required String id}) {
    switch (this) {
      ...
      default:
      // Lưu ý: Trường hợp SIGN_UP chưa được xử lý.
      // Bạn có thể muốn thêm nó vào đây hoặc để default throw error là đúng.
        return throw "404 - Endpoint not found";
    }
  }
}